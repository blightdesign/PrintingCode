...
void setup() 
{
  ...
  font.draw("B"); // if you're drawing in a canvas object, do font.draw("B", canvas);
  font.draw("A"); // if you're drawing in a canvas object, do font.draw("B", canvas);
  font.draw("R"); // if you're drawing in a canvas object, do font.draw("B", canvas);
  font.draw("C"); // if you're drawing in a canvas object, do font.draw("B", canvas);
  font.draw("I"); // if you're drawing in a canvas object, do font.draw("B", canvas);
  font.draw("A"); // if you're drawing in a canvas object, do font.draw("B", canvas);
  font.draw("-"); // if you're drawing in a canvas object, do font.draw("B", canvas);
  font.draw("C"); // if you're drawing in a canvas object, do font.draw("B", canvas);
