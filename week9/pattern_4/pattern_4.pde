 ...
 int unit = 5;
  ...
  for(int x = 0; x < width; x += step*2)
  {
    for(int y = 0; y < height; y += step*2)
    {
      ...
      aLogo = new Logo( x, y, 270, unit, kolor, bgColor);
      aLogo.displayA();
      
      bLogo = new Logo( x, y,  270, unit, kolor, bgColor);
      bLogo.displayB();
      
      cLogo = new Logo( x, y,  90, unit, kolor, bgColor);
      cLogo.displayC();
      
      dLogo = new Logo( x, y, 90, unit, kolor, bgColor);
      dLogo.displayD(); 
    }
  }
}
