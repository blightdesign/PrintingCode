...
{ 
  ...
  canvas.beginDraw();
    ...
    canvas.pushMatrix();
      ...
      font.draw("K", canvas); // if you're drawing in a canvas object, do font.draw("B", canvas);
      font.draw("P", canvas); // if you're drawing in a canvas object, do font.draw("B", canvas);
