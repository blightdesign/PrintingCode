...
void setup()
{
  ...
  ModularGrid grid = new ModularGrid(6, 4, 0, 50);
  ...
  Module startModule = grid.modules[4][0];
  Module textModule  = grid.modules[5][0];
  Module topColor    = grid.modules[4][0];
  Module midColor    = grid.modules[1][1];
  Module botColor    = grid.modules[2][2];
  ...
  fill(255,255,0,25);
  rect(botColor.x, botColor.y,botColor.w, botColor.h*2 + grid.gutterSize);
  fill(255,255,0,100);
  rect(midColor.x, midColor.y,midColor.w *4, midColor.h*2 + grid.gutterSize);
  fill(255,255,0,255);
  rect(topColor.x, topColor.y,topColor.w *2, topColor.h*2 + grid.gutterSize);
  fill(255,255,255);
